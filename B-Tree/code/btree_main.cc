...
int main(int argc,char **argv)
{
   ...
   char filename1[40],filename2[40],outfilename[40];
   strcpy(filename1,"B200.blocks");
   strcpy(filename2 ,"B200.nets");
   strcpy(outfilename,"B200.pl");
   ...
   srand( rand_seed );
     ...
     SimAnneal(fp, 400, 7, 0.1);
     fp.writeModuleOut(outfilename);
     fp.optimize_terminals(filename2);
     fp.writeTerminalOut(outfilename);
     clock_t done=clock();
